...
class EnterpriseList extends React.Component {
    ...
    stop = record => {
        const options ={
            ...
            data: {
                ...
                status: record.applicationEnterpriseStatus === 'ACTIVE' ? 'INACTIVE' : 'ACTIVE',
                offset: 1,
                limit: 15,
            },
            dataType: 'json',
    ...
    getColumns = () => [{
        ...
        render: (text, record) => {
            return(
                record.applicationEnterpriseStatus === 'ACTIVE' ? <span> 启用</span>:<span>禁用</span>
            )
        },
    }, {
        title: '操作',
        ...
        render: (text, record) => {
            return (
                <span>
                    ...
                    { record.applicationEnterpriseStatus ==="ACTIVE" ?
                    ...
                    { record.managerUserId ?
                        <a href="javascript:void(0)" onClick={() => this.edit(record)}>变更企业管理员</a>
                      :
                        <a href="javascript:void(0)" onClick={() => this.edit(record)}>配置企业管理员</a>
                    }
                </span>
            );
        },
    ...
    getDataSource = () => {
        ...
        data.map((investigation, i) => {
            investigations.push({
                ...
                applicationEnterpriseStatus: investigation.applicationEnterpriseStatus,
                managerUserId:investigation.managerUserId,
                managerUserName:investigation.managerUserName
            });
        });
