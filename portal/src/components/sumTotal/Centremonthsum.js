...
class Centremonthsum extends React.Component {
    state = {
        loading: false,
        searchArray: {
  ...
  /* onChangeRangeTime = value => {
        ...
        searchArray.begin = value[0].format(MonthFormat);
        searchArray.end = value[1].format(MonthFormat);
    ...
    render() {
        ...
        return (
            <div className="content">
                <Sider selectKey='Centremonthsum'/>
             <div className="main">
