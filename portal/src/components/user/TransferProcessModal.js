...
class ProcessModal extends Component {
    ...
    prospectiveAssign(requirementId, processedEmployees, newEmployees) {
        ...
        const options = {
            method: 'POST',
            url: `${API_URL.user.prospectiveAssign}?${params}` ,
            data: {},
            doneResult: ( data => {
    ...
    handleSubmit = () => {
        ...
        const options = {
            method: 'POST',
            url: `${API_URL.user.assignEmployee}?${param}`,
            doneResult: ( data => {
    ...
    loadData = id => {
        ...
        const options = {
            method: 'get',
            url: `${API_URL.user.fteSettleInfo}?requirementId=${id}`,
            doneResult: ( data => {
        ...
        return (
            ...
            >
                <div style={{ textAlign: 'center' }}>
                    <label style={{ fontSize: `${16}px` }}>交接任务处理</label>
                    <br />
                    <br />
