...
class HospitalDepartmentList extends React.Component {
    ...
    loadData = (params = {}) => {
        ...
        const options ={
            method: 'POST',
            url: `${API_URL.hospital.queryDepartmentListByInves}`,
            data: {
                offset: 1,
                limit: 15,
                ...params,
    ...
    getDataSource = () => {
        ...
        data.map((investigation, i) => {
            investigations.push({
                ...
                id: investigation.hospitalDepartmentId,
    ...
    render() {
        ...
        return (
            <div className="content">
                <SideNav selectKey='departmentDetail' ref={el => {this.siderRef = el;}} />
                ...
                <DepartmentView ref={el => { this.previewModalRef = el; }} />                
            </div>
        );
    }
}
